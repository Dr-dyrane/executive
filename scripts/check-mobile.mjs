...
const [mobileCss, layout, profileLayout, homePage, profilePage, mobilePortal, issueExperience] = await Promise.all([
  read("app/mobile.css"),
  read("app/layout.tsx"),
...
const checks = [
  ...
  ["profile exposes every mobile anchor", ["profile", "portfolio", "career", "now", "access", "rooms", "network", "sources"].every((id) => profilePage.includes(`id=\"${id}\"`))],
